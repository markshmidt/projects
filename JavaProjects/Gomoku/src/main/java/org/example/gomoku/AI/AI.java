...
public class AI implements AII {
    ...
    public int[] minimax(Board board, Cell playerCell) {
        ...
        for (int i = 0; i < possibleMoves.length; i++) {
            ...
            int score = minimaxValue(board, 4, false, playerCell, opponentCell, alpha, beta);
...
//        }
    ...
    public int minimaxValue(Board board, int depth, boolean isMaximizing, Cell playerCell, Cell opponentCell, int alpha, int beta) {
        ...
        for (int i = 0; i < possibleMoves.length; i++) {
            ...
            board.setTile(row, col, isMaximizing ? playerCell : opponentCell);
            ...
            int score = minimaxValue(board, depth - 1, !isMaximizing, playerCell, opponentCell, alpha, beta);
