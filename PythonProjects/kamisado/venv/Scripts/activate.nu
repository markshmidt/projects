...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin-PC\PycharmProjects\pythonProject4\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin-PC\PycharmProjects\pythonProject4\venv\Scripts\deactivate.nu'
